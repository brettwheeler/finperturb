...
- `arms\finmem\data\runs\rehearsal_flat_momentum.jsonl`

Rows: 140 (140 ok, 0 not ok)

**140 rows carry no context stamp** (written before the field existed).
...
phi = **0.2822** (mean over 2 items)


| item | n | floor actions | phi | 95% CI (resampling this item's runs) |
|---|---|---|---|---|
| S01 | 30 | {'buy': 29, 'hold': 1} | 0.0644 | [0.0000, 0.1800] |
| S02 | 30 | {'buy': 15, 'hold': 15} | 0.5000 | [0.4200, 0.5000] |
...
|---|---|---|---|---|---|
| N1 | 1 | 0.0000 | 0.0169 | -0.0169 | [-0.0169, -0.0169] |
| N2 | 0 | — | — | — | not run |
| N3 | 1 | 0.0000 | 0.0169 | -0.0169 | [-0.0169, -0.0169] |
...
|---|---|---|---|---|
| S01 | 0.0169 | 0.0000 (1.000 / 1.000 / 1.000) | — | 0.0000 (1.000 / 1.000 / 1.000) |
| S02 | 0.0303 | — | — | — |
...
|---|---|---|---|---|---|
| N1 | 1 | 0.0000 | 0.0333 | -0.0333 | [-0.0333, -0.0333] |
| N2 | 0 | — | — | — | not run |
| N3 | 1 | 0.0000 | 0.0333 | -0.0333 | [-0.0333, -0.0333] |
...
|---|---|---|---|---|
| S01 | 0.0333 | 0.0000 (-0.0333) | — | 0.0000 (-0.0333) |
| S02 | 0.2000 | — | — | — |
...
| item | phi | N1 | N2 | N3 |
|---|---|---|---|---|
| S01 | 0.0644 | 0.0000 (n=20) | — | 0.0000 (n=20) |
| S02 | 0.5000 | — | — | — |
...
|---|---|---|---|---|---|---|---|
| N1 | 1 | 1/1 | 20 | 0.0000 | 0.0644 | -0.0644 | [-0.0644, -0.0644] |
| N2 | 0 | 0/0 | 0 | — | — | — | not run |
| N3 | 1 | 1/1 | 20 | 0.0000 | 0.0644 | -0.0644 | [-0.0644, -0.0644] |
...
|---|---|---|---|
| S01 | buy | +1.000 | {'buy': 20} |
| S02 | buy | +0.400 | {'buy': 14, 'hold': 6} |

N1 JSD spread: min 0.0000 / median 0.0000 / max 0.0000

N3 JSD spread: min 0.0000 / median 0.0000 / max 0.0000
