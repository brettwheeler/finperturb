...
- `arms\finmem\data\runs\rehearsal_borderline.jsonl`

Rows: 130 (130 ok, 0 not ok)

**130 rows carry no context stamp** (written before the field existed).
...
phi = **0.6378** (mean over 1 items)


| item | n | floor actions | phi | 95% CI (resampling this item's runs) |
|---|---|---|---|---|
| S03 | 30 | {'sell': 13, 'buy': 6, 'hold': 11} | 0.6378 | [0.5267, 0.6644] |
...
|---|---|---|---|---|---|
| N1 | 1 | 0.0227 | 0.0274 | -0.0047 | [-0.0047, -0.0047] |
| N2 | 0 | — | — | — | not run |
| N3 | 1 | 0.1371 | 0.0274 | +0.1097 | [+0.1097, +0.1097] |
...
|---|---|---|---|---|
| S03 | 0.0274 | 0.0227 (0.413 / 0.413 / 0.413) | — | 0.1371 (0.029 / 0.057 / 0.057) |
...
|---|---|---|---|---|---|
| N1 | 1 | 0.1500 | 0.1833 | -0.0333 | [-0.0333, -0.0333] |
| N2 | 0 | — | — | — | not run |
| N3 | 1 | 0.4000 | 0.1833 | +0.2167 | [+0.2167, +0.2167] |
...
|---|---|---|---|---|
| S03 | 0.1833 | 0.1500 (-0.0333) | — | 0.4000 (+0.2167) |
...
| item | phi | N1 | N2 | N3 |
|---|---|---|---|---|
| S03 | 0.6378 | not interpretable (phi = 0.638) | — | not interpretable (phi = 0.638) |
...
|---|---|---|---|---|---|---|---|
| N1 | 1 | 0/1 | 60 | 0.5500 | 0.6378 | -0.0878 | [-0.0878, -0.0878] |
| N2 | 0 | 0/0 | 0 | — | — | — | not run |
| N3 | 1 | 0/1 | 20 | 0.7000 | 0.6378 | +0.0622 | [+0.0622, +0.0622] |
...
with their item's baseline MORE often than two runs on identical input agree
with each other — the perturbation moved the decision less than the agent's own
sampling does.


The bootstrap resamples items and there are 1, so the interval is
...
|---|---|---|---|
| S03 | hold | +0.250 | {'hold': 10, 'sell': 5, 'buy': 5} |

N1 JSD spread: min 0.0227 / median 0.0227 / max 0.0227

N3 JSD spread: min 0.1371 / median 0.1371 / max 0.1371
...
|---|---|---|---|---|
| N1 | +0.150 | -0.050 | -0.100 | 0.150 |
| N3 | -0.200 | -0.200 | +0.400 | 0.400 |
...
| klass | actions |
|---|---|
| FLOOR | {'sell': 13, 'buy': 6, 'hold': 11} |
| BASE | {'hold': 10, 'sell': 5, 'buy': 5} |
| N1 | {'hold': 27, 'buy': 24, 'sell': 9} |
| N3 | {'sell': 13, 'hold': 6, 'buy': 1} |
